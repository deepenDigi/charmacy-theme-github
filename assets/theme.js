...
// start drop down open one at a time
  ...
  theme.collapsibles = (function() {
    ...
    function toggle(evt) {
      ...
      if (isOpen) {
        ...
        var col_buttons = document.querySelectorAll('.collapsible-trigger');
        col_buttons.forEach(function(button) {
          ...
          if(el.innerText == col_buttons[col_buttons.length-1].innerText){
            if (button.classList.contains('is-open')) {
              button.classList.remove('is-open');
            }else{
              el.classList.add(classes.open);
    ...
    function setTransitionHeight(container, height, isOpen, isAutoHeight) {
      ...
      theme.utils.prepareTransition(container, function() {
        ...
        if (isOpen) {
          ...
          var col_content = document.querySelectorAll('.collapsible-content');
        col_content.forEach(function(button) {
          if (button.classList.contains('is-open')) {
            button.classList.remove('is-open');
...
// end drop down open one at a time
  ...
  theme.Product = (function() {
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      cacheElements: function() {
        ...
        // console.log(this.container.querySelector(this.selectors.productImageMain), "this.container.querySelector(this.selectors.productImageMain)")
      },
      ...
      imageSetArguments: function(variant) {
        ...
        return {
          cellSelector: '[data-group="'+set+'"], [data-group="color_general"]',
          imageSet: set,
      ...
      updateImageSet: function(evt) {
        ...
        // this.settings.currentImageSet.classList.toggle("general__image__set");
      ...
      updateImageSetThumbs: function(set) {
        this.cache.thumbSlider.querySelectorAll('.product__thumb-item').forEach(thumb => {
          ...
          if(thumb.dataset.group == "color_general" && thumb.dataset.group != "" &&  thumb.dataset.group != undefined){
            thumb.classList.remove(classes.hidden, thumb.dataset.group == "color_general");
          }
        });
      },
